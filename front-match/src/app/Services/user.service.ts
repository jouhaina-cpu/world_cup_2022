...
export class UserService {
  ...
  public getUsers():Observable<User[]>{
    return this.http.get<[User]>(`${this.apiServerUrl}/user/all`,{ headers: { Authorization: `Bearer ${this.tokenStorage.getToken()}` } });
  }

  public addUser(user: User): Observable<void> {
    return this.http.post<void>(`${this.apiServerUrl}/auth/signup`, user);
  }
